...
from util import read_paths_from_cli


def predict(catalog_path, waveform_path, model_path):
...
if __name__ == '__main__':
    ...
    catalog_path, waveform_path, model_path = read_paths_from_cli()
    predict(catalog_path, waveform_path, model_path)