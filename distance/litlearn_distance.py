...
def predtrue_timespan(catalog_path, checkpoint_path, hdf5_path, timespan=None):
    ...
    axs.scatter(x, y, c=z, cmap=cm, marker="D",s = 0.3,alpha = 0.3,lw = 0,
    ...
    axs.scatter(x, y,  c=z, cmap=cm, marker="s", s= 0.3,alpha = 0.3,lw = 0,
    ...
    x, y, z = x[idx], y[idx], z[idx]
    axs.scatter(x, y, c=z, cmap=cm, s=0.5, marker="s",lw = 0,
                alpha=0.2, label="Recordings without a S-Wave arrival")
    ...
    axs.scatter(x, y, s=0.5, c=z, cmap=cm, marker="D",lw = 0,
                alpha=0.2, label="Recordings in which there is a S-Wave arrival")
    if timespan is not None:
        axs.legend(title=str(timespan) + ' seconds after P-Wave arrival', loc='best', fontsize=7, title_fontsize=8)
    else:
        axs.legend(loc=0)
    ...
    cm = plt.cm.get_cmap('autumn')
    x, y, z = x[idx], y[idx], z[idx]
    axs.scatter(x, y, c=z, cmap=cm, s=3, marker="s",lw = 0,
    ...
    axs.scatter(x, y, s=3, c=z, cmap=cm, marker="D",lw = 0,
